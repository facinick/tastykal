...
public class DatabaseHelper2 extends SQLiteOpenHelper {
    ...
    String DB_PATH = null;
    private static String DB_NAME = "recommenddb";
    ...
    public Cursor query2(Boolean distinct, String table, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy,String limit) {
        return myDataBase.query(distinct, table, columns, selection, selectionArgs, null, null, null,null);
    }
